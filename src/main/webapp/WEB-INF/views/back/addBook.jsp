                        ...
                        <div class="layui-form-item">
                            <div class="layui-inline">
                                ...
                                <div class="layui-input-inline">
                                    <input type="tel" name="bookName" class="layui-input" lay-verify="required">
                                </div>
                            </div>
                        </div>
                        <div class="layui-form-item">
                    ...
                    <div style="margin-left: 20px">
                        <div class="layui-form-item">
                            ...
                            <div class="layui-upload">
                                ...
                                <div class="layui-input-block" style="margin-top: 5px">
                                    <img class="layui-upload-img" id="demo1" name="picture"  style="height: 200px;width: 200px">
                                    <p id="demoText"></p>
                                </div>
                            </div>
                        </div>
                        <div class="layui-form-item layui-form-text">
                            ...
                            <div class="layui-input-block" >
                                <textarea placeholder="请输入内容" class="layui-textarea" name="describe" style="width: 500px;height: 300px"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
